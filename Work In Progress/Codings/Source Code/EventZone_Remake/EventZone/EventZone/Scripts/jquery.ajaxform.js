jQuery.fn.extend({
    ...
    ajaxForm: function (options, onResponse) {
        ...
        ///     &#8226; data: String, Object, or Array<br />
        ///     The data to send.<br />
                    ...
                    if (validate != null) {
                        ...
                        if (result != true) {
                            if (typeof result === 'string') {
                                ...
                                if (onResponse) {
                                    onResponse(false, undefined, undefined, result);
                                } else {
                    ...
                    if (!form.hasClass(postingClass)) {
                        ...
                        var ajaxOptions = {
                            ...
                            success: function (responseObject, b, response) {
                                ...
                                if (onResponse) {
                                    onResponse(true, response.status, response.statusText, responseObject);
                                } else {
                            ...
                            error: function (response) {
                                ...
                                if (onResponse) {
                                    onResponse(false, response.status, response.statusText, responseObject);
                                } else {
