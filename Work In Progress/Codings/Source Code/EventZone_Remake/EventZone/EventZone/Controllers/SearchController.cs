...
namespace EventZone.Controllers
{
    public class SearchController : Controller
    {
        ...
        public ActionResult CategorySearch(Category model)
        {
            List<Event> listEvent = new List<Event>();
            long[] categoryList = new long[1];
            categoryList[0] = model.CategoryID;
            listEvent = EventDatabaseHelper.Instance.SearchByCategory(listEvent, categoryList);
