...
namespace EventZone.Models
{
    public class UsersAdminController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "UserID,UserName,UserPassword,UserFirstName,UserLastName,UserEmail,UserDOB,IDCard,UserRoles,Phone,Place,AccountStatus,Gender,AvatarLink")] User user, long AdminID)
        {
